node {
    ...
    common.build_rpm('rbberger/lammps-testing:fedora_22')

    stage 'Archive RPMs'
    archive includes:'rpmbuild/**/*.rpm'

    sh 'mkdir -p ${LAMMPS_DOWNLOAD_RPM_DIR}/fedora/22'
    sh 'find ${LAMMPS_DOWNLOAD_RPM_DIR}/fedora/22 -mtime +30 -exec rm {} \\;'
    sh 'cp -R rpmbuild/RPMS/x86_64 ${LAMMPS_DOWNLOAD_RPM_DIR}/fedora/22'
