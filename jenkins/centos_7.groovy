...
node {
    ...
    build_rpm('rbberger/lammps-testing:centos_7')

    stage 'Archive RPMs'
    archive includes:'rpmbuild/**/*.rpm'

    sh 'mkdir -p ${LAMMPS_DOWNLOAD_RPM_DIR}/centos/7'
    sh 'find ${LAMMPS_DOWNLOAD_RPM_DIR}/centos/7 -mtime +30 -exec rm {} \\;'
    sh 'cp -R rpmbuild/RPMS/x86_64 ${LAMMPS_DOWNLOAD_RPM_DIR}/centos/7'
