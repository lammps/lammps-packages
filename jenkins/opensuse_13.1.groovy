...
node {
    ...
    build_rpm('rbberger/lammps-testing:opensuse_13.1')
 
    stage 'Archive RPMs'
    archive includes:'rpmbuild/**/*.rpm'

    sh 'mkdir -p ${LAMMPS_DOWNLOAD_RPM_DIR}/opensuse/13.1'
    sh 'cp -R rpmbuild/RPMS/x86_64 ${LAMMPS_DOWNLOAD_RPM_DIR}/opensuse/13.1'
