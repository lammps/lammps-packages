node {
    ...
    common.build_rpm('rbberger/lammps-testing:opensuse_42.2')
 
    stage 'Archive RPMs'
    archive includes:'rpmbuild/**/*.rpm'

    sh 'mkdir -p ${LAMMPS_DOWNLOAD_RPM_DIR}/opensuse/42.2'
    sh 'find ${LAMMPS_DOWNLOAD_RPM_DIR}/opensuse/42.2 -mtime +30 -exec rm {} \\;'
    sh 'cp -R rpmbuild/RPMS/x86_64 ${LAMMPS_DOWNLOAD_RPM_DIR}/opensuse/42.2'
